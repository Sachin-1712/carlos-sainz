...
deterministic. It has been **run against the live API and passes** -- the provider's parsing is
confirmed against the real service, not only against a fixture. To re-run it from a machine that
can reach `api.jolpi.ca`:
